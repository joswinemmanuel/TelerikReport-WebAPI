...
namespace TelerikReportWebAPI.Reports
{
    ...
    public class BaseReport : Telerik.Reporting.Report, IBaseReport
    {

        public void InitializeComponent()
        {
            // Your existing InitializeComponent code here
            ...
            // Make sure to initialize this.reportTable
        }
        ...
        {
            // Override this method in derived classes to add specific columns
        }
        ...
        // InitializeComponent method should be implemented in derived classes
